...
//post route - for auto refreshing comment section
router.get("/refresh/:id", ensureAuth, postsController.refreshPost);
...
router.put("/likedPost/:id", postsController.likedPost);
